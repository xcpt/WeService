<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="site_payment_list.aspx.cs" Inherits="Weservice.Web.admin.order.site_payment_list" ValidateRequest="false" %>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a href="payment_list.aspx"><i class="iconfont icon-app"></i><span>平台管理</span></a></li>
          <li><a href="site_payment_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>"><i class="iconfont icon-close"></i><span>新增</span></a></li>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  <tr>
    ...
    <th align="left" width="16%">所属平台</th>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#new Weservice.BLL.sites().GetTitle(Utils.StrToInt(Eval("site_id").ToString(),0))%></td>
    <td><%#Eval("ptitle")%></td>
    <td><asp:TextBox ID="txtSortId" runat="server" Text='<%#Eval("sort_id")%>' CssClass="sort" onkeydown="return checkNumber(event);" /></td>
    <td><%#string.Format("{0:g}",Eval("add_time"))%></td>
    <td align="center"><a href="site_payment_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a></td>
  </tr>
</ItemTemplate>
<FooterTemplate>
