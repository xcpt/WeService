<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="order_confirm.aspx.cs" Inherits="Weservice.Web.admin.order.order_confirm" ValidateRequest="false" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#new Weservice.BLL.site_payment().GetTitle(Convert.ToInt32(Eval("payment_id")))%></td>
    <td><%#new Weservice.BLL.express().GetTitle(Convert.ToInt32(Eval("express_id")))%></td>
