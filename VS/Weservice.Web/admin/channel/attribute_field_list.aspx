<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="attribute_field_list.aspx.cs" Inherits="Weservice.Web.admin.channel.attribute_field_list" ValidateRequest="false" %>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a href="attribute_field_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>"><i class="iconfont icon-close"></i><span>新增</span></a></li>
...
<div class="table-container">
  ...
  <ItemTemplate>
    <tr>
      ...
      <td align="center"><%#Convert.ToInt32(Eval("is_required")) == 1 ? "√" : "×"%></td>
