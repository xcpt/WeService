...
namespace Weservice.Web.admin.channel
{
    public partial class channel_edit : Web.UI.ManagePage
    {
        ...
        private string GetInherit(string page_type)
        {
            ...
            {
                case "index":
                    result = "Weservice.Web.UI.Page.article";
                    break;
                case "category":
                    result = "Weservice.Web.UI.Page.category";
                    break;
                case "list":
                    result = "Weservice.Web.UI.Page.article_list";
                    break;
                case "detail":
                    result = "Weservice.Web.UI.Page.article_show";
                    break;
            }
            return result;
        }
