<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="channel_list.aspx.cs" Inherits="Weservice.Web.admin.channel.channel_list" ValidateRequest="false" %>
<%@ Import namespace="Weservice.Common" %>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a href="channel_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>"><i class="iconfont icon-close"></i><span>新增</span></a></li>
          ...
          <li><asp:LinkButton ID="btnDelete" runat="server" OnClientClick="return ExePostBack('btnDelete','删除后将无法恢复数据，是否继续？');" onclick="btnDelete_Click"><i class="iconfont icon-delete"></i><span>删除</span></asp:LinkButton></li>
        </ul>
        <div class="menu-list">
...
<div class="table-container">
  ...
  <ItemTemplate>
    <tr>
      ...
      <td><%#Eval("name")%></td>
      <td><%#Eval("title")%></td>
      <td><%#new Weservice.BLL.sites().GetTitle(Convert.ToInt32(Eval("site_id")))%></td>
      <td align="center"><%#Convert.ToInt32(Eval("is_comment")) == 0 ? "×" : "√"%></td>
