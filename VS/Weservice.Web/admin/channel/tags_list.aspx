<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tags_list.aspx.cs" Inherits="Weservice.Web.admin.channel.tags_list" ValidateRequest="false" %>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a href="tags_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>"><i class="iconfont icon-close"></i><span>新增</span></a></li>
          ...
          <li><asp:LinkButton ID="btnRed" runat="server" onclick="btnRed_Click"><i class="iconfont icon-good"></i><span>推荐</span></asp:LinkButton></li>
...
<div class="table-container">
  ...
  <ItemTemplate>
    <tr>
      ...
      <td align="center"><%#Convert.ToInt32(Eval("is_red")) == 1 ? "√" : "×"%></td>
      <td><asp:TextBox ID="txtSortId" runat="server" Text='<%#Eval("sort_id")%>' CssClass="sort" onkeydown="return checkNumber(event);" /></td>
      <td><%#string.Format("{0:g}",Eval("add_time"))%></td>
      <td align="center"><a href="tags_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a></td>
    </tr>
  </ItemTemplate>
  <FooterTemplate>
