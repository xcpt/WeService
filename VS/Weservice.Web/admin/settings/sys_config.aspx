<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sys_config.aspx.cs" Inherits="Weservice.Web.admin.settings.sys_config" ValidateRequest="false" %>
...
<div class="tab-content">
  ...
  <dl>
    ...
    <dd>
      ...
      <span class="Validform_checktip">*以“http://”开头，全局域名通讯时使用到</span>
    </dd>
  </dl>
  <dl>
    <dt>公司名称</dt>
...
<div class="tab-content" style="display:none">
  <dl>
    ...
    <dd>
      ...
      <span class="Validform_checktip">尚未申请？<a href="http://www.Weservice.net" target="_blank">请点击这里注册</a></span>
    </dd>
  </dl>
  <dl>
    <dt>短信API地址</dt>
  ...
  <dl>
    ...
    <dd>
      ...
      <span class="Validform_checktip">*短信账户注册的用户名</span>
    </dd>
  </dl>
  <dl>
    <dt>平台通讯密钥</dt>
    <dd>
      ...
      <span class="Validform_checktip">*开通短信账户设置的通讯密钥</span>
    </dd>
  </dl>
  <dl>
    <dt>短信平台说明</dt>
    <dd>
      ...
      如果您尚未申请开通，<a href="http://www.Weservice.net" target="_blank">请点击这里注册</a>成功后填写您的用户名和通讯密钥均可正常使用。
    </dd>
  </dl>
</div>
<!--/手机短信设置-->
  ...
  <dl>
    ...
    <dd>
      <div class="rule-multi-radio">
        ...
        <asp:ListItem Value="HW">补白</asp:ListItem>
        </asp:RadioButtonList>
      </div>
    </dd>
  </dl>
