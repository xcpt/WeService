<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="article_list.aspx.cs" Inherits="Weservice.Web.admin.article.article_list" ValidateRequest="false" %>
...
<div class="table-container">
  ...
  <ItemTemplate>
    <tr>
      ...
      <td><%#new Weservice.BLL.article_category().GetTitle(Convert.ToInt32(Eval("category_id")))%></td>
