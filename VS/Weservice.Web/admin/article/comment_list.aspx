<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="comment_list.aspx.cs" Inherits="Weservice.Web.admin.article.comment_list" ValidateRequest="false" %>
    ...
    <tr>
      <td class="comment">
        <div class="title">
          ...
          <%#new Weservice.BLL.article().GetTitle(this.channel_id, Convert.ToInt32(Eval("article_id")))%>
        </div>
        <div class="ask">
