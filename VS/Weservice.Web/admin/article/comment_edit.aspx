<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="comment_edit.aspx.cs" Inherits="Weservice.Web.admin.article.comment_edit" %>
...
<div class="tab-content">
  <dl>
    <dt>信息标题</dt>
    <dd><%=new Weservice.BLL.article().GetTitle(model.channel_id, model.article_id)%></dd>
  </dl>
  <dl>
    <dt>评论用户</dt>
