<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="Weservice.Web.admin.index" %>
    ...
    <div class="nav-right">
      <div class="info">
        ...
        <span>
          ...
          <%=new Weservice.BLL.manager_role().GetTitle(admin_info.role_id) %>
        </span>
      </div>
      <div class="option">
