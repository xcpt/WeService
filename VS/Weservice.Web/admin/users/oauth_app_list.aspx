<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="oauth_app_list.aspx.cs" Inherits="Weservice.Web.admin.users.oauth_app_list" ValidateRequest="false" %>
    ...
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          ...
          <li><a href="oauth_app_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>"><i class="iconfont icon-close"></i><span>新增</span></a></li>
...
<ItemTemplate>
  <tr>
    ...
    <td><a href="oauth_app_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>"><%#Eval("title")%></a></td>
    ...
    <td align="center"><a href="oauth_app_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a></td>
  </tr>
</ItemTemplate>
<FooterTemplate>
