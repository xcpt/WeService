<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="message_list.aspx.cs" Inherits="Weservice.Web.admin.users.message_list" ValidateRequest="false" %>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a href="message_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>"><i class="iconfont icon-close"></i><span>发送</span></a></li>
...
<ItemTemplate>
  <tr>
    ...
    <td align="center"><a href="message_edit.aspx?action=<%#DTEnums.ActionEnum.View %>&id=<%#Eval("id")%>">查看</a>
  </tr>
</ItemTemplate>
<FooterTemplate>
