<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_audit.aspx.cs" Inherits="Weservice.Web.admin.users.user_audit" ValidateRequest="false" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#new Weservice.BLL.user_groups().GetTitle(Convert.ToInt32(Eval("group_id")))%></td>
