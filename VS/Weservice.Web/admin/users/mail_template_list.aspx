<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mail_template_list.aspx.cs" Inherits="Weservice.Web.admin.users.mail_template_list" ValidateRequest="false" %>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a href="mail_template_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>"><i class="iconfont icon-close"></i><span>新增</span></a></li>
