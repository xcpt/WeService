...
namespace Weservice.API.Payment.alipaypc
{
    /// <summary>
    /// 类名：Notify
    /// 功能：支付宝通知处理类
    ...
    public class Notify
    {
        public int site_payment_id;
        #region 字段
        private string _partner = string.Empty;               //合作身份者ID
        private string _key = string.Empty;                   //交易安全校验码
        private string _input_charset = string.Empty;         //编码格式
        private string _sign_type = string.Empty;             //签名方式
        ...
        public Notify(int _site_payment_id)
        {
            site_payment_id = _site_payment_id;
