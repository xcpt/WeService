...
namespace Weservice.Web.UI.Page
{
    public partial class usercenter : Web.UI.UserPage
    {
        ...
        protected override void InitPage()
        {
            ...
            if (action == "exit")
            {
                ...
                //清除Cookies
                Utils.WriteCookie(DTKeys.COOKIE_USER_NAME_REMEMBER, "Weservice", -43200);
                Utils.WriteCookie(DTKeys.COOKIE_USER_PWD_REMEMBER, "Weservice", -43200);
                Utils.WriteCookie("UserName", "Weservice", -1);
                Utils.WriteCookie("Password", "Weservice", -1);
                //自动登录,跳转URL
