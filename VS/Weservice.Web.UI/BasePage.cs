...
namespace Weservice.Web.UI
{
    public partial class BasePage : System.Web.UI.Page
    {
        ...
        public bool IsUserLogin()
        {
            ...
            {
                //检查Cookies
                string username = Utils.GetCookie(DTKeys.COOKIE_USER_NAME_REMEMBER, "Weservice");
                string password = Utils.GetCookie(DTKeys.COOKIE_USER_PWD_REMEMBER, "Weservice");
